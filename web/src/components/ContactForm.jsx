...
export default function Contact() {
  ...
  return (
    ...
    >
      <h2 className="text-4xl font-bold text-[#b4637a] dark:text-[#eb6f92] mb-8 text-center">Contact Me</h2>
      ...
      >
        ...
        <button
          type="submit"
          className="bg-[#b4637a] dark:bg-[#eb6f92] text-[#191724] px-6 py-3 rounded-2xl font-medium hover:opacity-90 transition"
        >
          Send Message
        </button>
      </form>
      <div className="mt-6 flex gap-6">
        <a
          href="https://github.com/leonie-falke"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-[#56949f] dark:bg-[#9ccfd8] text-[#191724] px-6 py-2 rounded-2xl font-medium hover:opacity-90 transition"
        >
          GitHub
        </a>
        <a
          href="mailto:leonie.marie.falke@protonmail.com"
